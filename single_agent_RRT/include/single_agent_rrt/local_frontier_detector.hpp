...
#define MAX_LEAF 1000
#define POINT_CLOUD_SIZE 200 // 100
...
class LocalFrontierDetector: public rclcpp::Node
{
    ...
    class RRTVisualizer {
        public:
            RRTVisualizer(rclcpp::Node* node) {
                this->rrt_node = node;
                this->marker_pub_ = rrt_node->create_publisher<visualization_msgs::msg::Marker>("/rrt_tree", 20);
            ...
            void clear_tree()
            {
                ...
                // for (int id = 0; id < this->marker_id_; id++)
                // {
                //     marker.id = id;
    ...
    private:
        ...
        // void active_frontier_callback(const geometry_msgs::msg::Point&);
        ...
        // TODO?
        bool RRT_is_outdated_frontier(const geometry_msgs::msg::Point&);
        ...
        // helper methods
        // geometry_msgs::msg::TransformStamped::SharedPtr get_robot_position();
        ...
        const double RRT_EXPANSION_RATE = 1.5;
